...
# returns none
    # ------------------------------------------------------------------
# https://www.geeksforgeeks.org/default-arguments-in-python/#:~:text=Python%20has%20a%20different%20way,of%20the%20form%20keywordname%3Dvalue.

    def method_with_defaults(self, a, b='default_value'):
        return [a, b]
# https://www.programiz.com/python-programming/function-argument
# if there is no second argument passed in, it defaults to the default_value
...
# swapped
    ...
    # ------------------------------------------------------------------
# docs https://docs.python.org/3/tutorial/classes.htmls
