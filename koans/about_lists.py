...
# https://www.geeksforgeeks.org/python-list/#:~:text=In%20Python%2C%20negative%20sequence%20indexes,second%2Dlast%20item%2C%20etc.
...
# inserting a string to the list at index given
