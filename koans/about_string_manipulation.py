...
#string interpolation {0} represents value1, {1} represents value2
...
# finds patter in a string, then splits
...
# https://www.netjstech.com/2019/07/changing-string-case-in-python.html
# notes for referencing case changes ^
