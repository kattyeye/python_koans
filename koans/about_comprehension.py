...
class AboutComprehension(Koan):
    ...
    def test_double_list_comprehension(self):
        ...
        comprehension = ['{0} and {1}'.format(
            egg, meat) for egg in list_of_eggs for meat in list_of_meats]

        # 0 index for list of eggs and meats
    ...
    def test_creating_a_dictionary_with_dictionary_comprehension(self):
        dict_of_weapons = {'first': 'fear', 'second': 'surprise',
                           ...
                           'fifth': None}
# pay attention to upper
        dict_comprehension = {k.upper(): weapon for k,
