...
# 23(b) here a !> b
    ...
    class doubleit:  # what the function should do
    ...
    def parrot(self, text):
        return text.upper()  # decorator doubles, this function returns uppercase text doubled
    ...
    def test_decorator_with_no_arguments(self):
        ...
        self.assertEqual("PIECES OF EIGHT, PIECES OF EIGHT",
                         self.parrot('pieces of eight'))
