...
# https://www.netjstech.com/2020/01/tuple-in-python-with-examples.html >>> Tuples Tutorial
...
class AboutTuples(Koan):
    ...
    def test_tuples_of_one_look_peculiar(self):
        self.assertEqual(int, (1).__class__) # class of the it
...
# where illuminati is location [0], stargate [1], Cthulu [2], and inside each tuple there is another layer of index
