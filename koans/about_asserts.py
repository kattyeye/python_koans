...
# changed from false to true to fix AssertionError

    def test_assert_with_message(self):
        """
        Enlightenment may be more easily achieved with appropriate messages.
        """
        self.assertTrue(True, "This should be True -- Please fix this") # changed from false to true to fix AssertionError
...
# Assertion is that 2 = 2 True
    ...
    def test_that_unittest_asserts_work_the_same_way_as_python_asserts(self):
        ...
        assert True
# another way to write an assertion
# changed from F to T
