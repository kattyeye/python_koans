...
# https://developpaper.com/question/__func_-attribute-of-python-3-x-instance-method/
...
# Called when dir() is called on the object. A sequence must be returned. dir() converts the returned sequence to a list and sorts it.
    ...
    def test_methods_have_different_attributes(self):
        obj = Class()
        self.assertEqual(27, len(dir(obj.method)))  # don't understand this
