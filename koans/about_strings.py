...
# put true because strings can have double and single quotation marks
...
# https://www.digitalocean.com/community/tutorials/how-to-format-text-in-python-3#:~:text=To%20create%20strings%20that%20span,double%20quotes%20on%20either%20side.
...
# https://www.geeksforgeeks.org/python-string-concatenation/#+ and other oages
# strings can be concatenated and appended with += like in JS
